...
to other bundlers like Metro which is used when developing React Native.
...
`require`. It also sets a bunch of other sensible default like externs
inference, so that advanced compilation will just work.
