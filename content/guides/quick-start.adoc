...
[source,bash]
----
java -cp "cljs.jar;src" --main cljs.main --compile hello-world.core --repl
----
...
[source,bash]
----
java -cp "cljs.jar;src" -m cljs.main --help
----
...
options for `-O` are `whitespace` and `simple` but these are less commonly used:
...
[source,bash]
----
java -cp "cljs.jar;src" -m cljs.main --optimizations advanced -c hello-world.core
----
...
[source,bash]
----
java -cp "cljs.jar;src" -m cljs.main --serve
----
...
[source,bash]
----
java -cp "cljs.jar;src" -m cljs.main --target node --output-to main.js -c hello-world.core
----
...
[source,bash]
----
java -cp "cljs.jar;src" -m cljs.main --repl-env node
----
