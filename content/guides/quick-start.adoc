...
8] and the
https://github.com/clojure/clojurescript/releases/download/r1.9.227/cljs.jar[standalone
...
https://github.com/clojure/clojurescript/releases/download/r1.9.227/cljs.jar[Download
