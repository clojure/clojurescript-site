...
What follows is a section-by-section review of sections on the left-hand navigation panels of http://clojure.org/about and http://clojure.org/reference, enumerating what is different in ClojureScript and in some cases the similarities.
...
* It is [designed to leverage Google's Closure library](./Google-Closure), and participates in its dependency/require/provide mechanism
...
Clojure and ClojureScript share the same http://clojure.org/contributing[Contributor Agreement and development process].