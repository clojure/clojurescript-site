...
* Tagged Literals 
** Similar to https://clojure.org/reference/reader[Clojure Tagged Literals], except that a reader function
should return a valid Clojurescript code form (which will be compiled to Javascript) whereas in Clojure
no further reading/compilation is done to the result.
