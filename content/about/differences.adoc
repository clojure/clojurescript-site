...
* Tagged Literals 
** The same as https://clojure.org/reference/reader[Clojure Tagged Literals], except that reader functions are similar to a Clojurescript macros, in that they
should return a valid Clojurescript code form or a literal (string, number).
