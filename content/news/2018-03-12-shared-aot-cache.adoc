...
In those cases, it is recommended that libraries and tooling employ `goog.define` instead, perhaps with the help of https://clojurescript.org/reference/compiler-options#closure-definesi[`:closure-defines`], as this makes JARs cache-friendly.
====
