...
ClojureScript no longer depends on transit-clj only transit-java. The dependence
on data.json has been removed. ClojureScript dependence on tools.reader is
