...
For a complete list of updates in ClojureScript 1.10.740 see
https://github.com/clojure/clojurescript/blob/master/changes.md#1.10.740[Changes].

## Contributors

Thanks to all of the community members who contributed to ClojureScript 1.10.740:
