...
our energies on the essential browser and Node.js REPLs as well enrichen the CLI
& REPL APIs to ease third party efforts to target these other JavaScript
environments.
