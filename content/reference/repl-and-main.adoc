...
* init options:
** `-co`, `--compile-opts` _edn_ Options to configure the build, can be an EDN string or colon separated list of EDN files / classpath resources. Options will be merged left to right.
...
** `-ro`, `--repl-opts` _edn_ Options to configure the repl-env, can be an EDN string or colon separated list of EDN files / classpath resources. Options options will be merged left to right.
...
init options:
  ...
  -ro, --repl-opts edn        Options to configure the repl-env, can be an EDN
                              string or colon separated list of EDN files /
                              classpath resources. Options options will be
