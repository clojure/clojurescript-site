...
Defaults to `true` unless ClojureScript is being used as a git dep. Controls whether a shared AOT cache is used for compiler artifacts produced from JARs.
