...
Defaults to `false` unless ClojureScript is being used via `cljs.main`. Controls whether the shared AOT cache is used for compiler artifacts produced from JARs.
